...
export const colors: NonNullable<NonNullable<NonNullable<Config['theme']>['extend']>['colors']> = {
  gray: {
    100: 'var(--ds-gray-100)',
    200: 'var(--ds-gray-200)',
    300: 'var(--ds-gray-300)',
  ...
  background: {
    ...
    secondary: 'var(--ds-background-100)',
  ...
  contrast: {
    ...
    hover: 'var(--ds-gray-800)',
  },
  text: {
    DEFAULT: 'var(--ds-gray-900)',
    secondary: 'var(--ds-gray-800)',
    muted: 'var(--ds-gray-700)',
    contrast: 'var(--ds-contrast-fg)',
  },
  status: {
    success: 'var(--ds-green-800)',
    failed: 'var(--ds-red-800)',
    warning: 'var(--ds-amber-800)',
    neutral: 'var(--ds-blue-800)',
  },
};
